...
tipo = st.selectbox('Selecciona la tarifa que quieres consultar: ', options=['Todas'] + df['tipo'].unique().tolist())
...
st.write(f'Gráficos generado para un consumo de  100 kW.')
